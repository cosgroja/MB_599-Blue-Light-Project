    ...
    with open(LCGCDataFile, 'r') as F:
        for line in F:
            if not line.startswith ('HMDBID') and not line.startswith('B/D'):
                ...
                BData = line.strip().split("\t")[1:8]
                DData = line.strip().split("\t")[8:]
...
#python scripts/06_PathwayVisual_14d.py 06_d14_pathway_results.txt 06_d14_name_map.txt 06_d14Data.txt
...
figureName = '14 days Blue Light Metabolomic Pathway Analysis'

pdfName = '06_14dMetabolomicPathwayResult.pdf'
