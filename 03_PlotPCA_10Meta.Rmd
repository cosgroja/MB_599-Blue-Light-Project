...
```{r}
metaTable <- read_csv('C:/Users/yangj/Box/phd/Dave Lab/R/MB599/BL Project/03 PCA/00_10LC.csv')
...
```{r}
ggexport(plotlist = list(eigPlot, cosPlot, DimPlot1, DimPlot2, conPlot, IndPlot, PCAPlot13), 
         filename = "03_10LCPCA.pdf", width = 8, height = 6)
```
